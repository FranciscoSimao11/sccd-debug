...
class Phone(RuntimeClassBase):
    ...
    def build_statechart_structure(self):
        ...
        # state /powered_on/history
        self.states["/powered_on/history"] = DeepHistoryState(12, "/powered_on/history", self)
        
        # state /state_Debug
        self.states["/state_Debug"] = State(13, "/state_Debug", self)
        self.states["/state_Debug"].setEnter(self._state_Debug_enter)
        self.states["/state_Debug"].setExit(self._state_Debug_exit)
        
        # state /state_Final
        self.states["/state_Final"] = State(14, "/state_Final", self)
        self.states["/state_Final"].setEnter(self._state_Final_enter)
        
        # state /state_Help
        self.states["/state_Help"] = State(15, "/state_Help", self)
        ...
        self.states["/powered_on"].addChild(self.states["/powered_on/history"])
        ...
        _powered_off_charging_0 = Transition(self, self.states["/powered_off/charging"], [self.states["/powered_on/history"]])
        ...
        # _powered_on_history to /state_Debug
        _powered_on_history_to_state_Debug = Transition(self, self.states["/powered_on/history"], [self.states["/state_Debug"]])
        _powered_on_history_to_state_Debug.setTrigger(pauseEvent)
        self.states["/powered_on/history"].addTransition(_powered_on_history_to_state_Debug)
        self.pauseTransitions["/powered_on/history"] = _powered_on_history_to_state_Debug
        
        # powered_on_history from /state_Debug
        _state_Debug_to_powered_on_history = Transition(self, self.states["/state_Debug"], [self.states["/powered_on/history"]])
        _state_Debug_to_powered_on_history.setTrigger(continueEvent)
        _state_Debug_to_powered_on_history.setGuard(self.continueGuard_powered_on_history)
        self.states["/state_Debug"].addTransition(_state_Debug_to_powered_on_history)
        
        # _powered_on_history to /state_Help
        _powered_on_history_to_state_Help = Transition(self, self.states["/powered_on/history"], [self.states["/state_Help"]])
        _powered_on_history_to_state_Help.setTrigger(helpEvent)
        self.states["/powered_on/history"].addTransition(_powered_on_history_to_state_Help)
        self.helpTransitions["/powered_on/history"] = _powered_on_history_to_state_Help
        
        # powered_on_history from /state_Help
        _state_Help_to_powered_on_history = Transition(self, self.states["/state_Help"], [self.states["/powered_on/history"]])
        _state_Help_to_powered_on_history.setTrigger(Event("_2after"))
        _state_Help_to_powered_on_history.setGuard(self.continueGuard_powered_on_history)
        self.states["/state_Help"].addTransition(_state_Help_to_powered_on_history)
        
        # _powered_on_history to /state_Final
        _powered_on_history_to_state_Final = Transition(self, self.states["/powered_on/history"], [self.states["/state_Final"]])
        _powered_on_history_to_state_Final.setTrigger(stopEvent)
        self.states["/powered_on/history"].addTransition(_powered_on_history_to_state_Final)
        self.stopTransitions["/powered_on/history"] = _powered_on_history_to_state_Final
    ...
    def _powered_on_charge_charging_enter(self):
        ...
        if self.firstTime == True:
            ...
            if self.scaleFactor != float("inf"):
                ...
                self.addTimer(1, 10.0 / self.scaleFactor)
            self.process_event_transitions("/powered_on/charge/charging")
            
            self.print_prompt()
        else:
            self.addTimer(1, 10.0 - ((self.localExecutionTime / 1000.0) / self.scaleFactor))
    ...
    def continueGuard_powered_on_history(self, parameters):
        return list(self.active_states.queue) == list([self.states["/powered_on/history"]])
