...
class GenericGenerator(Visitor):
    ...
    # def visit_DebugActions(self):
    #     Logger.showInfo("Debug")
    ...
    def visit_ClassDiagram(self, class_diagram):
        ...
        #self.writer.addInclude(["argparse"])
        ...
        # Debug Controller - not used
        # self.writer.beginClass("DebugController", ["DebugControllerBase"])
        # self.writer.beginConstructor()
        # self.writer.addFormalParameter("controller")
        # self.writer.beginMethodBody()
        # self.writer.beginSuperClassConstructorCall("DebugControllerBase")
        # self.writer.addActualParameter("controller")
        # self.writer.endSuperClassConstructorCall()
        # self.writer.endMethodBody()
        # self.writer.endConstructor()
    ...
    def visit_Constructor(self, constructor):
        ...
        if constructor.parent_class.attributes:
            ...
            #self.writer.addAssignment(GLC.SelfProperty("attrsDebug"), "[]")
        ...
        if self.debug_mode == 1:
            ...
            for s in statechart.states:
                if not s.is_root:
                    ...
                    self.writer.addComment("to "+ debugName)      
                    self.writer.addAssignment(
                    ...
                    self.writer.addComment("from "+ debugName)
                    self.writer.addAssignment(
